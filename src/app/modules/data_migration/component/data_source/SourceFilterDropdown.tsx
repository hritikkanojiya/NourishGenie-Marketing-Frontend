...
import { GetDataSourceOptions } from "../../models/data_sources/app_datasource.model";

const initialValues: GetDataSourceOptions = {
...
export const SourceFilterDropdown: FC<Props> = ({ setFilterOptions }) => {
  ...
  const resetForm = () => {
    ...
    formik.setFieldValue("appDataSourceId", null);
    formik.resetForm();
  };
