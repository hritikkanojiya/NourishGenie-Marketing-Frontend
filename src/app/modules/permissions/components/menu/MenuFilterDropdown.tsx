...
export const MenuFilterDropdown: FC<Props> = ({ setFilterOptions }) => {
  ...
  const clearHasSubMenu = () => formik.setFieldValue("hasSubMenus", null);
  ...
  const resetForm = () => {
    ...
    formik.setFieldValue("appMenuId", null);
      ...
      <form onSubmit={formik.handleSubmit} className="form">
        ...
        <div className="px-7 py-5 pb-0">
          ...
          <div className="fv-row row mb-5">
            <label className="form-label fw-bold">Sub Menu</label>
            <div className="col-5">
