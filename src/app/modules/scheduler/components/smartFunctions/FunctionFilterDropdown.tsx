...
import { GetFunctionsOptions } from "../../models/smart_functions.model";

const initialValues: GetFunctionsOptions = {
...
export const FunctionFilterDropdown: FC<Props> = ({ setFilterOptions }) => {
        ...
        <div className='px-7 py-5 pb-0'>
          <div className="fv-row mb-5">
            ...
            <div className="position-relative">
              <i className="fa fa-search fs-5 text-gray-400 position-absolute top-50 translate-middle ms-6">
              </i>
              <input
            ...
            <small className="form-text text-muted"><b>Search</b> in name, description</small>
          </div>
        </div>
        <div className='px-7 py-5 pb-0'>
          <div className="fv-row mb-5">
