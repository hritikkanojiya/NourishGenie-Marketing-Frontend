...
import { GetConstantOptions } from "../models/app_constants.model";

const initialValues: GetConstantOptions = {
  appConstantId: null,
  isAutoLoad: null,
  search: null,
  page: 1,
...
export const ConstantFilterDropdown: FC<Props> = ({ setFilterOptions }) => {
  ...
  const resetForm = () => {
    ...
    formik.setFieldValue("appConstantId", null);
    formik.resetForm();
  };

  const clearAutoLoad = () => {
    formik.setFieldValue("isAutoLoad", null);
  };
