...
import { GetCampaignsOptions } from "../models/campaign.model";

const initialValues: GetCampaignsOptions = {
  appCampaignId: null,
  search: null,
  page: 1,
};
...
export const AppCampaignFilterDropdown: FC<Props> = ({ setFilterOptions }) => {
